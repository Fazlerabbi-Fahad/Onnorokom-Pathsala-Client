                ...
                user?.email ?
                    <>
                        ...
                        <div>
                            {
                                user?.photoURL ?
                                    <img title={user?.displayName} className='mr-5 mt-3 border rounded-full' style={{ height: '30px' }} src={user?.photoURL} alt="" />
                                    :
                                    <FaUserAlt title={user?.displayName} className='my-5 mr-10' />
                            }
                        </div>
